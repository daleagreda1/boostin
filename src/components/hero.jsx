...
const Hero = () => {
  return (
    ...
    <div className="px-[6rem] py-[12.8rem]">
       ...
       <div class="absolute flex">
       <p className="paragraph-award mr-auto ml-10 mt-[17rem] w-[32rem] h-12 text-base font-plus-jakarta-sans
       ...
       <div>
       <button className="schedulecall justify between mt-[24rem] mr-auto ml-[-32rem] w-[14rem] h-[3.2rem] pt-[0.7rem] pr-[4rem] bg-black text-white py-2 px-8 border-2 
       ...
       <button className="btnViewCaseStudy absolute mt-[24.4rem] ml-[4rem] text-black w-40 h-10 text-base underline 
       ...
       <div>
       <p className="Trustedtext mt-[32rem] ml-[-42rem] mr-1 text-base text-black w-48 h-5 font-semibold font-plus-jakarta-sans">
       Trusted by the world's biggest brands
       </p>
       <div class="absolute flex w-full items-center mr-auto ml-[-26rem] mt-[-0.8rem]">
       <img className="trilogo"
        ...
        <img className="barline mt-[-8.8rem] ml-[11.2rem] bg-white" src={barline} width={54} height={20} alt="barline"/>
        </div>
        </div>
        <div className="absolute flex">
        <h1 className="bartext absolute mr-auto ml-[15rem] mt-[-11.9rem] text-white text-base w-60 font-plus-jakarta-sans">Drive More Traffic and Sales</h1>
        <h1 className="bartext2 mr-auto ml-[11rem] mt-[-8.6rem] text-white font-semibold text-4xl w-[20rem] 
