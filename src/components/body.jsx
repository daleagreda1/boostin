...
const body = () => {
  return (
    <div className="px-28 py-[2rem] ">
      ...
      <p className="pprovide flex ml-auto mr-[8.6rem] mt-[-4.8rem] text-gray-600 text-xl w-[42rem] h-32 leading-relaxed font-medium font-plus-jakarta-sans"> 
      ...
      <div className="px-24 py-10">
      <div>
      <img class="wework ml-auto mr-[2.6rem] mt-[-28.8rem]"
        src={wework} 
        width={820} 
        height={200} 
        alt="wework"          
      ...
      <div>
      <img class="weworkcircle ml-auto mr-[2rem] mt-[4.8rem]"
        src={weworkcircle} 
        width={163} 
        height={163} 
        alt="weworkcircle"          
      />
      <p className="howwework ml-[45rem] mt-[-16rem] w-[40rem] text-white text-5xl font-semibold font-plus-jakarta-sans leading-[67.20px] tracking-[12.96px]"> HOW WE WORK </p>
      </div>
      </div>
    </div>
  );
